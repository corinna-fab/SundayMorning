...
class ChatViewController: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        messages.append(Message(sender: selfSender, messageId: "1", sentDate: Date(), kind: .text("Hello World Message Hello World Message Hello World Message v Hello World Message Hello World Message Hello World Message Hello World Message")))
